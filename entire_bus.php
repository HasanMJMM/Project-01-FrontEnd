...
<head>
    ...
    <link rel="stylesheet" href=" ./css/entire_bus.css">
    <title>Entire Bus Booking</title>
...
<body>
    ...
    <div class="container-fluid bg-dark text-light py-3">
        <div class="d-flex justify-content-center">
            <h1 class="display-6"> Entire Bus Booking</h1>
        </div>
    </div>
    <section class="container my-2 bgdark w-50 text">
        <form class="row g-3p-3">
            ...
            <div class="col-md-6">
                <label for="inputEmail4" class="form-label">Number of Pessengers</label>
            ...
            <div class="col-md-4">
                <label for="validationCustom02" class="form-label">Days of Journey</label>
                <input type="text" class="form-control" id="validationCustom02" required>
            ...
            <div class="col-md-6">
                    <div class="input-group mb-10">
                        <span class="input-group-text mt-3" id="basic-addon1">Start Date</span>
